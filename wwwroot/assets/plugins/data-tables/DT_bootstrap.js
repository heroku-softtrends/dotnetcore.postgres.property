    ...
    "bootstrap_extended": {
        "fnInit": function( oSettings, nPaging, fnDraw ) {
            ...
            $(nPaging).append(
                ...
                '<a href="#" class="btn btn-sm default prev disabled" title="' + oLang.sPrevious + '"><i class="icon-angle-left"></i></a>' +
                ...
                '<a href="#" class="btn btn-sm default next disabled" title="' + oLang.sNext + '"><i class="icon-angle-right"></i></a> ' +
